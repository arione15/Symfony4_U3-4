...
class AdminTypeController extends AbstractController
{
     ...
     */
    public function supprimerType(Type $type = null, Request $request, EntityManagerInterface $manager) // $type peut être nul dans le cas de la création. Dans ce cas il faut instancier Type pour pouvoir créer un formulaire qui sera vide du coup
    {
        if(!$type){
            $type = new Type();
        }
