...
class AdminTypeController extends AbstractController
{
     ...
     */
    public function ajouEtModif(Type $type = null, Request $request, EntityManagerInterface $manager) // $type peut être nul dans le cas de la création
    {
        if(!$type){
            $type = new Type(); // Si $type est nul
        }
