...
class AdminTypeController extends AbstractController
{
    ...
    /**
     * @Route("/admin/type/{id}", name="suppressionType")
     */
    public function supprimerajouEtModif(Type $type = null, Request $request, EntityManagerInterface $manager) // $type peut être nul dans le cas de la création. Dans ce cas il faut instancier Type pour pouvoir créer un formulaire qui sera vide du coup
    {
        if(!$type){
            $type = new Type();
        }
