...
class AdminAlimentController extends AbstractController
{
    ...
    public function modifierEtAjouterAliment(Aliment $aliment = null, Request $request, EntityManagerInterface $entityManager)
    {
        ...
        if($form->isSubmitted() && $form->isValid()) {
            $modif = $aliment -> getId() !== null; // si l'aliment n'existe pas, et bien qu'il ait été crée avec if(!$aliment) $aliment = new Aliment, il n'existe pas encore en BD mais il n'est pas encore
